    ...
    <h2 class="label">All registered users</h2>
        ...
        <div class="sorting">
          ...
          <form class="search-inputs">
            <img src="../assets/loop.png" alt="Search Icon" class="img-loop"/>
        ...
        <div class="searching2">
              <form v-on:submit.prevent="filterForm" >
                ...
                <select id="sortParamter2" v-model="filter.nameType" class="search-part1" >
          ...
          <button @click="sortAsc" class="user-icon">
            <img src="../assets/upArrow.png" alt="Sort Icon" class="user-img" />
          </button>
          <button @click="sortDesc" class="user-icon">
      ...
      <form>
            <div class="horizontal">
              ...
              <div class="border-container">
                ...
                <button type="button" v-if="user.userRole !== 'Administrator'" class="button-block" @click="blockUser(user)">
...
export default {
    ...
    filteredUsers: function () {
      return this.users.filter((user) => {
        return (
          ...
          user.lastName.toLowerCase().match(this.searchLastName.toLowerCase()) &&
  ...
  async blockUser(profile) {
      ...
      const token = localStorage.getItem("token");
      axios
        .put(`http://localhost:3000/users/` + profile.id, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
